...
BASE_OUTPUT_DIR="/DATA4/amishi/5Apr/dorado_hac_comparison"
DORADO_BIN="/usr/bin/dorado"
BASE_MODEL="/DATA4/amishi/dorado_models/dna_r10.4.1_e8.2_400bps_hac@v5.0.0"
METHYL_MODEL="/DATA4/amishi/dorado_models/dna_r10.4.1_e8.2_400bps_hac@v5.0.0_5mCG_5hmCG@v3"
Q_SCORES=(5 10 15 20)
